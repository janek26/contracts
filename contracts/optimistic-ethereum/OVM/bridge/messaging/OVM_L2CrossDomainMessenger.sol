...
} from "../../../iOVM/bridge/messaging/iOVM_L2CrossDomainMessenger.sol";
import {
    iOVM_L1MessageSender
} from "../../../iOVM/precompiles/iOVM_L1MessageSender.sol";
import {
    iOVM_L2ToL1MessagePasser
} from "../../../iOVM/precompiles/iOVM_L2ToL1MessagePasser.sol";

/* Contract Imports */
import {
    Abs_BaseCrossDomainMessenger
} from "./Abs_BaseCrossDomainMessenger.sol";
    ...
    Lib_AddressResolver
{
    ...
    function _verifyXDomainMessage() internal view returns (bool _valid) {
        return (iOVM_L1MessageSender(resolve("OVM_L1MessageSender"))
    ...
    function _sendXDomainMessage(
        ...
        iOVM_L2ToL1MessagePasser(resolve("OVM_L2ToL1MessagePasser"))
