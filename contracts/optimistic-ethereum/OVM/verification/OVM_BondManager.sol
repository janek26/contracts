...
import {
    ...
    Errors,
    ERC20
} from "../../iOVM/verification/iOVM_BondManager.sol";
import {
    iOVM_FraudVerifier
...
contract OVM_BondManager is iOVM_BondManager, Lib_AddressResolver {
    ...
    function recordGasSpent(
        ...
        address transitioner =
            address(
                iOVM_FraudVerifier(resolve("OVM_FraudVerifier"))
    ...
    function finalize(
        ...
        if (
            ...
            uint256(bond.withdrawalTimestamp) >
            timestamp + disputePeriodSeconds &&
    ...
    function finalizeWithdrawal() public override {
        ...
        require(
            block.timestamp >=
                uint256(bond.withdrawalTimestamp) + disputePeriodSeconds,
            Errors.TOO_EARLY
        );
    ...
    function claim(address who) public override {
        ...
        // contract forever
        uint256 amount =
            (requiredCollateral * rewards.gasSpent[msg.sender]) /
                (2 * rewards.total);
    ...
    function getGasSpent(bytes32 preStateRoot, address who)
        public
        view
        override
        returns (uint256)
