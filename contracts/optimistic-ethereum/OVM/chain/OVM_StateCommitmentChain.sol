    ...
    Lib_AddressResolver
{
    ...
    function appendStateBatch(
        ...
        require(
            iOVM_BondManager(resolve("OVM_BondManager")).isCollateralized(
                msg.sender
            ),
    ...
    function insideFraudProofWindow(
        ...
        (uint256 timestamp, ) =
            abi.decode(_batchHeader.extraData, (uint256, address));
        ...
        internal
    {
        ...
        (uint40 totalElements, uint40 lastSequencerTimestamp) =
            _getBatchExtraData();
        ...
        if (msg.sender == sequencer) {
            ...
            require(
                lastSequencerTimestamp + SEQUENCER_PUBLISH_WINDOW <
                    block.timestamp,
