...
import {
    Lib_RingBuffer
} from "../../optimistic-ethereum/libraries/utils/Lib_RingBuffer.sol";
...
contract TestLib_RingBuffer {
    ...
    function getLength() internal view returns (uint40) {
        return buf.getLength();
    }

    function getExtraData() internal view returns (bytes27) {
